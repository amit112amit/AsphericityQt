...
void MainWindow::on_slider2_valueChanged(double position){
...
double_t MainWindow::calculateAsphericity(vtkSmartPointer<vtkPolyData> pd){
...
double_t MainWindow::calculateRMSAd(vtkSmartPointer<vtkPolyData> p){
...
void MainWindow::on_slider1_valueChanged(double position){
